...
parser.add_argument('modality', type=str, choices=['RGB', 'Flow', 'YUV', 'GRAY'])
...
parser.add_argument('--input_size', default=256, type=int, help='input resolution (must be multiple of 32)')
